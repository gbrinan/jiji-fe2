      ...
      <div className="flex-1 flex flex-col items-center px-4">
        ...
        <div className="w-full px-4 mt-auto mb-8">
          ...
          <div className="flex justify-center gap-4">
            {/* Naver */}
            <button className="w-11 h-11 rounded-full overflow-hidden">
              <div className="w-full h-full bg-[#03C75A] flex items-center justify-center text-white font-bold text-xl">N</div>
            </button>
            {/* KakaoTalk */}
            <button className="w-11 h-11 rounded-full bg-[#FEE500] flex items-center justify-center overflow-hidden">
              <span className="font-bold text-sm text-gray-900">TALK</span>
            </button>
            {/* Apple */}
            <button className="w-11 h-11 rounded-full bg-black flex items-center justify-center">
